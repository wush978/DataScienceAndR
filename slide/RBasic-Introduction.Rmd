...
```{r corrplot, results = "hide", echo = TRUE}
library(corrplot)
corrplot(Ca)
```
...
- 悠久的統計分析歷史
    - 豐富的統計檢定實作
    - 豐富的統計模型實作
    - 優秀的結構化資料API(Data.Frame)
- 廣大的使用人口
    - 套件成長速度飛快
    - 雨後春筍般的非結構化與半結構化資料處理套件
    - 各種Open Source教材與學習資源
...
- 總共有破千個關卡，所以有bug 的機會很高。歡迎到<https://github.com/wush978/DataScienceAndR/issues>回報：
    - 看不懂的敘述
    - 有錯字
    - 程式卡住
    - 讓你不爽的體驗...

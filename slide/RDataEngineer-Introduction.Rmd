---
title       : R語言與資料處理
author      : Wush Wu, HJ Hsu and Johnson Hsieh
...
<center><img src="http://i.imgur.com/Lf5Q79U.png" style="max-width: 100%;max-height: 100%" /></center>

--- &fullimg `r bg("12613244714_d0dd1f4dc2_o.jpg")`

<https://flic.kr/p/kdAbds>

*** =notes

資料的品質

--- &fullimg `r bg("21842381502_c7ffb3e55b_o.jpg")`

<https://flic.kr/p/zh8V3w>
...
## 如何用R 建立簡易地製作Dashboard?

1. 整理資料 - 02-RDataEngineer-...
2. 視覺化 - 03-RVisualization-...
    - R 套件[googlesheets](https://github.com/jennybc/googlesheets) + Google Drive ([Demo](https://goo.gl/44Bx4u))
3. 將上述工作自動化
    - [五分鐘建立R的命令列應用程式](https://youtu.be/A1IIcZW5UrI) + 搭配作業系統的定期排程
    - [Rstudio有開發相關功能](http://www.r-bloggers.com/new-rstudio-add-in-to-schedule-r-scripts/)
